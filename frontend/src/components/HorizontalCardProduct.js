                            ...
                            <Link key={product._id} to={"product/" + product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                                ...
                                <div className='p-4 grid'>
                                    ...
                                    <div className='flex gap-2'>
                                        <p className='text-red-600 font-medium sm:font-bold text-sm md:text-base'>{displayINRCurrency(product?.sellingPrice)}</p>
                                        <p className='text-slate-500 line-through text-sm md:text-base'>{displayINRCurrency(product?.price)}</p>
                                    </div>
